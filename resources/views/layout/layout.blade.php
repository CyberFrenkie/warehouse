...
<html lang="en">
  <head>
    ...
    @vite(['resources/sass/apps.scss', 'resources/js/app.js'])
    ...
    <div class="wrapper text-center">
        <div class="header">
            <nav class="navbar navbar-expand-lg">
                <div class="nav-wrap container-fluid nav-container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="/warehouse">Warehouse</a>
                            </li>
                        </ul>
                    </div>
                </div>
